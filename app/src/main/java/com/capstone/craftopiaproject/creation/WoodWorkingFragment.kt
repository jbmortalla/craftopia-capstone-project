...
class WoodWorkingFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        toolsButton = view.findViewById(R.id.woodTools)
        creationsButton = view.findViewById(R.id.woodCreations)
        rawMaterialsButton = view.findViewById(R.id.woodRawMaterials)
    ...
    private fun fetchDataFromFirebase(subcategory: String? = null) {
        var query = firestore.collection("products").whereEqualTo("category", "Woodworking")
