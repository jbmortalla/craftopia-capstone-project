...
class ArtVisualFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_art_visual, container, false)
        recyclerView = view.findViewById(R.id.artVisualRecycler)
        ...
        val backButton: ImageButton = view.findViewById(R.id.art_backbutton)
        backButton.setOnClickListener {
            requireActivity().onBackPressed()
        }

        toolsButton = view.findViewById(R.id.artTools)
        creationsButton = view.findViewById(R.id.artCreations)
        rawMaterialsButton = view.findViewById(R.id.artRawMaterials)
    ...
    private fun fetchDataFromFirebase(subcategory: String? = null) {
        var query = firestore.collection("products").whereEqualTo("category", "Art & Visual Creations")
    ...
    companion object {
        fun newInstance() = ArtVisualFragment()
    }
}